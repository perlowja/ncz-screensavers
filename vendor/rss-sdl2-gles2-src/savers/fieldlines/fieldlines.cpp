...
void handleCommandLine(int argc, char* argv[]){
	setDefaults();
	getArgumentsValue(argc, argv, std::string("-ions"), dIons, 1, 50);
	getArgumentsValue(argc, argv, std::string("-stepsize"), dStepSize, 1, 100);
	getArgumentsValue(argc, argv, std::string("-maxsteps"), dMaxSteps, 1, 10000);
	getArgumentsValue(argc, argv, std::string("-width"), dWidth, 1, 100);
	getArgumentsValue(argc, argv, std::string("-speed"), dSpeed, 1, 100);
	int b;
	if(getArgumentsValue(argc, argv, std::string("-constwidth"), b, 0, 1) >= 0) dConstwidth = b;
	if(getArgumentsValue(argc, argv, std::string("-electric"), b, 0, 1) >= 0) dElectric = b;
}
#endif
