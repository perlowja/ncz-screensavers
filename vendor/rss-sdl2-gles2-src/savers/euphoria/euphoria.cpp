...
void handleCommandLine(int argc, char* argv[]){
	...
	setDefaults(defaults);
	getArgumentsValue(argc, argv, std::string("-wisps"), dWisps, 0, 100);
	...
	getArgumentsValue(argc, argv, std::string("-visibility"), dVisibility, 1, 100);
	getArgumentsValue(argc, argv, std::string("-speed"), dSpeed, 1, 100);
	getArgumentsValue(argc, argv, std::string("-feedback"), dFeedback, 0, 100);
	getArgumentsValue(argc, argv, std::string("-feedbackspeed"), dFeedbackspeed, 1, 100);
	getArgumentsValue(argc, argv, std::string("-feedbacksize"), dFeedbacksize, FEEDBACKSIZE_MIN, FEEDBACKSIZE_MAX);
	getArgumentsValue(argc, argv, std::string("-wireframe"), dWireframe, 0, 1);
	getArgumentsValue(argc, argv, std::string("-texture"), dTexture, 0, 4);
}
#endif
