...
/* Include our X11/Intrinsic.h shim instead of the system one -- we don't
 * have Xt installed. The shim provides typedefs (XtPointer, XtInputId,
 * XtAppContext) and the constants and stub implementations the
 * loader_cb code paths reference. */
