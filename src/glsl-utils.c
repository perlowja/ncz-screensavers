 ...
 * implied warranty.
 *
 * Vendored for ncz-screensavers from xscreensaver 6.15
 ...
 * #define). Both come from xscreensaver_compat.h.
 */

/* xscreensaver_compat.h transitively pulls in <stdio.h>, <stdlib.h>,
 * <math.h>, <string.h>, <time.h>; those are also pulled in below.
 *
 * xscreensaver_compat.h also pulls in gl4es_include/GL/gl.h (GL1 only)
 * and, under NCZ_GLES3_BUILD, the system GLES3/gl32.h. The GLSL entry
 * points we route through (glCreateShader, glCompileShader, glLinkProgram,
